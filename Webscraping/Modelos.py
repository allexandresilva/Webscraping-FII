''' Aqui serão criadas as classes do projeto
>> Lista dos campos para criação das classes <<

Papel, Segmento, Cotação, FFO Yield, Dividend Yield, P/VP, Valor de Mercado, Liquidez, Qtd. de Imóveis, Preço do m2,
Aliguel do m2, Cap Rate, Vacância Média.
'''
...
class Estrategia:
    def __init__(self, segmento="", cotacao_atual_minima=0, ffo_yield_minimo=0, dividend_yield_minimo=0, p_vp_minimo=0,
        ...
        self.ffo_yeld_minimo = ffo_yield_minimo
        ...
        self.qt__minima_imoveis = qt_minima_imoveis
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                or fundo.ffo_yeld < self.ffo_yeld_minimo \
                ...
                or fundo.qt_imoveis < self.qt__minima_imoveis \
